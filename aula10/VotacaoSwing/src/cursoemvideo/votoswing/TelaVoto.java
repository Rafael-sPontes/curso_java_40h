 ...
 */
package cursoemvideo.votoswing;
...
public class TelaVoto extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtNasc, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(btnVoto)
                .addGap(18, 18, 18)
                .addComponent(lblRes, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotoActionPerformed
        ...
        if ((idade >= 16 && idade <18) || (idade > 70)) {
            lblRes.setText("<html>Sua idade é: <strong>" + idade + "</strong>, portanto o Voto é <strong>OPCIONAL</strong></html>");
        } else if (idade >= 18 && idade <= 70) {
            lblRes.setText("<html>Sua idade é: <strong>" + idade + "</strong>, portanto o Voto é <strong>OBRIGATÓRIO!</strong></html>");
        } else {
            lblRes.setText("<html>Sua idade é: <strong>" + idade + "</strong>, portanto <strong>NÃO</strong> Vota!</html>");
        }
